...
3) We're just reading inputs from a single file, we would have to introduce a read/write lock for inserting into a single CircularArr from multiple streaming inputs
4) latency is +ve. (we're resetting to 0)

Usage:

./StatsCollector "/Users/pshah/Desktop/StatsCollector/Sample.txt"
